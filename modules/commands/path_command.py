...
class PathCommand(BaseCommand):
    ...
    settings_schema = [
        ...
        {
            "key": "max_proximity_range",
            "label": "Max proximity range",
            "type": "float",
            "min": 0,
            "default": 200.0,
            "unit": "km",
        ...
        {
            "key": "max_repeater_age_days",
            "label": "Max repeater age",
            "type": "int",
            "min": 0,
            "default": 14,
            "unit": "days",
        ...
        {
            "key": "recency_decay_half_life_hours",
        ...
        {
            "key": "minimum_path_bytes",
            "label": "Minimum path bytes",
            "type": "int",
            "min": 0,
            "default": 0,
        ...
        {
            "key": "enable_p_shortcut",
            "label": "Enable 'p' shortcut",
            "type": "bool",
            "default": True,
        ...
        # Confidence symbols
        {
            "key": "high_confidence_symbol",
            "label": "High-confidence symbol",
            "type": "str",
            "default": "🎯",
            "help": "Marker for high-confidence path results.",
        },
        {
            "key": "medium_confidence_symbol",
            "label": "Medium-confidence symbol",
            "type": "str",
            "default": "📍",
            "help": "Marker for medium-confidence path results.",
        },
        {
            "key": "low_confidence_symbol",
            "label": "Low-confidence symbol",
            "type": "str",
            "default": "❓",
            "help": "Marker for low-confidence path results.",
        },
        # Graph-based validation
        {
            "key": "graph_based_validation",
            "label": "Graph validation",
            "type": "bool",
            "default": True,
            "help": "Use the mesh graph to validate candidate paths.",
        },
        {
            "key": "min_edge_observations",
            "label": "Min edge observations",
            "type": "int",
            "min": 1,
            "default": 3,
            "help": "Minimum observations before a graph edge is trusted.",
        },
        {
            "key": "graph_use_bidirectional",
            "label": "Bidirectional edges",
            "type": "bool",
            "default": True,
            "help": "Treat graph edges as bidirectional.",
        },
        {
            "key": "graph_use_hop_position",
            "label": "Use hop position",
            "type": "bool",
            "default": True,
            "help": "Factor average hop position into graph scoring.",
        },
        {
            "key": "graph_multi_hop_enabled",
            "label": "Multi-hop graph",
            "type": "bool",
            "default": True,
            "help": "Allow multi-hop graph traversal during validation.",
        },
        {
            "key": "graph_multi_hop_max_hops",
            "label": "Multi-hop max hops",
            "type": "int",
            "min": 1,
            "default": 2,
            "help": "Maximum hops considered for multi-hop graph traversal.",
        },
        {
            "key": "graph_geographic_combined",
            "label": "Combine graph + geo",
            "type": "bool",
            "default": False,
            "help": "Combine graph evidence with geographic proximity.",
        },
        {
            "key": "graph_geographic_weight",
            "label": "Geographic weight",
            "type": "float",
            "min": 0,
            "max": 1,
            "default": 0.7,
            "help": "Weight of geography when combined with graph evidence.",
        },
        {
            "key": "graph_confidence_override_threshold",
            "label": "Confidence override threshold",
            "type": "float",
            "min": 0,
            "max": 1,
            "default": "",
            "help": "Graph confidence above which geography is overridden. Blank = preset.",
        },
        {
            "key": "graph_prefer_stored_keys",
            "label": "Prefer stored keys",
            "type": "bool",
            "default": True,
            "help": "Prefer stored public keys when identifying nodes.",
        },
        {
            "key": "graph_zero_hop_bonus",
            "label": "Zero-hop bonus",
            "type": "float",
            "min": 0,
            "default": 0.4,
            "help": "Confidence bonus for direct (zero-hop) links.",
        },
        # Distance penalty
        {
            "key": "graph_distance_penalty_enabled",
            "label": "Distance penalty",
            "type": "bool",
            "default": True,
            "help": "Penalise graph links that span implausibly long distances.",
        },
        {
            "key": "graph_max_reasonable_hop_distance_km",
            "label": "Max reasonable hop distance",
            "type": "float",
            "min": 0,
            "default": "",
            "unit": "km",
            "help": "Distance beyond which the penalty applies. Blank = preset.",
        },
        {
            "key": "graph_distance_penalty_strength",
            "label": "Distance penalty strength",
            "type": "float",
            "min": 0,
            "default": "",
            "help": "How strongly long hops are penalised. Blank = preset.",
        },
        # Final-hop proximity
        {
            "key": "graph_final_hop_proximity_enabled",
            "label": "Final-hop proximity",
            "type": "bool",
            "default": True,
            "help": "Weight the final hop by geographic proximity.",
        },
        {
            "key": "graph_final_hop_proximity_weight",
            "label": "Final-hop weight",
            "type": "float",
            "min": 0,
            "max": 1,
            "default": "",
            "help": "Weight of final-hop proximity. Blank = preset.",
        },
        {
            "key": "graph_final_hop_max_distance",
            "label": "Final-hop max distance",
            "type": "float",
            "min": 0,
            "default": 0.0,
            "unit": "km",
            "help": "Max final-hop distance considered. 0 = unlimited.",
        },
        {
            "key": "graph_final_hop_proximity_normalization_km",
            "label": "Final-hop normalization",
            "type": "float",
            "min": 0,
            "default": 200.0,
            "unit": "km",
            "help": "Distance used to normalise final-hop proximity.",
        },
        {
            "key": "graph_final_hop_very_close_threshold_km",
            "label": "Final-hop very-close",
            "type": "float",
            "min": 0,
            "default": 10.0,
            "unit": "km",
            "help": "Distance treated as 'very close' for the final hop.",
        },
        {
            "key": "graph_final_hop_close_threshold_km",
            "label": "Final-hop close",
            "type": "float",
            "min": 0,
            "default": 30.0,
            "unit": "km",
            "help": "Distance treated as 'close' for the final hop.",
        },
        {
            "key": "graph_final_hop_max_proximity_weight",
            "label": "Final-hop max weight",
            "type": "float",
            "min": 0,
            "max": 1,
            "default": 0.6,
            "help": "Upper bound on the final-hop proximity weight.",
        },
        # Path validation bonus
        {
            "key": "graph_path_validation_max_bonus",
            "label": "Validation max bonus",
            "type": "float",
            "min": 0,
            "default": 0.3,
            "help": "Maximum confidence bonus from graph path validation.",
        },
        {
            "key": "graph_path_validation_obs_divisor",
            "label": "Validation obs divisor",
            "type": "float",
            "min": 0.1,
            "default": 50.0,
            "help": "Observations divisor controlling how the validation bonus scales.",
        },
        # Path-byte gating
        {
            "key": "require_path_bytes_greater_or_equal_to",
            "label": "Require path bytes ≥",
            "type": "int",
            "min": 0,
            "max": 3,
            "default": 0,
        ...
        {
            "key": "require_path_bytes_failure_response",
            "label": "Path-byte reject reply",
            "type": "str",
            "default": "",
        ...
        {
            "key": "graph_write_strategy",
            "label": "Graph write strategy",
            "type": "enum",
            "options": [
        ...
        {
            "key": "graph_batch_interval_seconds",
            "label": "Graph batch interval",
            "type": "int",
            "min": 1,
            "default": 30,
            "unit": "s",
        ...
        {
            "key": "graph_batch_max_pending",
            "label": "Graph batch max pending",
            "type": "int",
            "min": 1,
            "default": 100,
        ...
        {
            "key": "graph_edge_expiration_days",
            "label": "Graph edge expiration",
            "type": "int",
            "min": 0,
            "default": 7,
            "unit": "days",
        ...
        {
            "key": "graph_startup_load_days",
            "label": "Graph startup load window",
            "type": "int",
            "min": 0,
            "default": 0,
            "unit": "days",
    ...
    def __init__(self, bot):
        ...
        self.recency_decay_half_life_hours = bot.config.getfloat(
            "Path_Command", "recency_decay_half_life_hours", fallback=12.0
        )
        ...
        self.graph_geographic_combined = bot.config.getboolean(
            "Path_Command", "graph_geographic_combined", fallback=False
        )
        ...
        self.graph_distance_penalty_enabled = bot.config.getboolean(
            "Path_Command", "graph_distance_penalty_enabled", fallback=True
        )
        ...
        self.graph_final_hop_proximity_enabled = bot.config.getboolean(
        ...
        self.graph_final_hop_max_distance = bot.config.getfloat(
            "Path_Command", "graph_final_hop_max_distance", fallback=0.0
        )
        self.graph_final_hop_proximity_normalization_km = bot.config.getfloat(
            "Path_Command", "graph_final_hop_proximity_normalization_km", fallback=200.0
        )  # Long LoRa range
        self.graph_final_hop_very_close_threshold_km = bot.config.getfloat(
            "Path_Command", "graph_final_hop_very_close_threshold_km", fallback=10.0
        )
        self.graph_final_hop_close_threshold_km = bot.config.getfloat(
            "Path_Command", "graph_final_hop_close_threshold_km", fallback=30.0
        )  # Typical LoRa range
        self.graph_final_hop_max_proximity_weight = bot.config.getfloat(
            "Path_Command", "graph_final_hop_max_proximity_weight", fallback=0.6
        )
        self.graph_final_hop_max_proximity_weight = max(
            0.0, min(1.0, self.graph_final_hop_max_proximity_weight)
        )  # Clamp to 0.0-1.0
        self.graph_path_validation_max_bonus = bot.config.getfloat(
            "Path_Command", "graph_path_validation_max_bonus", fallback=0.3
        )
        self.graph_path_validation_max_bonus = max(
            0.0, min(1.0, self.graph_path_validation_max_bonus)
        )  # Clamp to 0.0-1.0
        self.graph_path_validation_obs_divisor = bot.config.getfloat(
            "Path_Command", "graph_path_validation_obs_divisor", fallback=50.0
        )
        ...
        if minimum_path_bytes_raw not in (0, 1, 2, 3):
            self.logger.warning(f"Invalid Path_Command.minimum_path_bytes={minimum_path_bytes_raw}; defaulting to 0")
                ...
                if lat is not None and lon is not None:
                    ...
                    if -90 <= lat <= 90 and -180 <= lon <= 180:
                        ...
                        if self.geographic_scoring_config_enabled:
                            ...
                            self.logger.info(
                                f"Geographic proximity guessing enabled with bot location: {lat:.4f}, {lon:.4f}"
                            )
                        else:
                            self.logger.info(
                                "Geographic proximity guessing disabled via config (geographic_scoring_enabled = false)"
                            )
    ...
    def _store_path_distance(self, distance_km: Optional[float], message: Optional[MeshMessage]) -> None:
    ...
    async def _decode_node_ids(self, node_ids: list[str], routing_info: Optional[dict[str, Any]] = None) -> str:
        ...
        self._store_path_distance(self._calculate_path_distance_km(node_ids, repeater_info, message), message)
        ...
        try:
            ...
            if "," in path_input:
                ...
                if tokens:
                    ...
                    valid_hex = all(
                        len(t) in (2, 4, 6) and all(c in "0123456789aAbBcCdDeEfF" for c in t) for t in tokens
                    )
                                    ...
                                    results.append(
                                        {
                                            ...
                                            "last_heard": row[
                                                "last_heard"
                                            ],  # Include last_heard for recency calculation
                                            "last_advert_timestamp": row.get(
                                                "last_advert_timestamp"
                                            ),  # Include last_advert_timestamp for recency calculation
                                            ...
                                            "role": row["role"],
                                            "is_starred": bool(
                                                row.get("is_starred", 0)
                                            ),  # Include star status for bias
                                        }
                                    )
                        except Exception as e:
                    ...
                    if hasattr(self.bot.meshcore, "contacts"):
                        for (
                            ...
                            if public_key_has_prefix(public_key, node_id):
                                ...
                                if hasattr(
                                    self.bot, "repeater_manager"
                                ) and self.bot.repeater_manager._is_repeater_device(contact_data):
                                    name = contact_data.get(
                                        "adv_name",
                                        contact_data.get("name", self.translate("commands.path.unknown_name")),
                                    )
        ...
        for i, line in enumerate(lines):
            ...
            if self._count_byte_length(current_message) + self._count_byte_length(line) + 1 > body_budget:
                if current_message:
                    ...
                    await self.send_response(message, out, skip_user_rate_limit=(message_count > 0))
